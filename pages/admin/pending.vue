        ...
        <div class="custom-card plan">
          ...
          <div v-if="showEditButton" class="input-wrapper w-form">
            <div class="input-form">
              ...
              <div v-if="this.transactionType != 'Deposit'" class="each-input">
                <label for="email-3" class="input-label"
                  >Receiver Name<span class="important">*</span></label
                ><input
                  type="text"
                  class="plan-input w-input"
              ...
              <div v-if="this.transactionType != 'Deposit'" class="each-input">
                <label for="email-3" class="input-label"
                  >Receiver Bank<span class="important">*</span></label
                ><input
                  type="text"
                  class="plan-input w-input"
              ...
              <div v-if="this.transactionType != 'Deposit'" class="each-input">
                <label for="email-3" class="input-label"
                  >Receiver Account Number<span class="important"
                    >*</span
                  ></label
                ><input
                  type="text"
...
export default {
  ...
  methods: {
    ...
    processTransaction() {
      if (this.transactionType == "Choose Transaction Type") {
        this.showResponseMsg(
          "Please choose transaction type to proceed.",
          true
        );
        return;
      }
